...
function Homepage() {
  ...
  const settings1 = {
    dots: true,
    infinite: slidesMovies.length > 4,
    speed: 500,
    slidesToShow: Math.min(slidesMovies.picture, 4),
    slidesToScroll: 1,
    autoplay: true,
        ...
        <div>
          <Slider  {...settingsMain}>
            {slidesMovies1.map((slide) =>
              <div key={slide.id}>
                <img className="w-full h-[120vh] object-cover " src={slide.picture} alt="" />
                ...
                <div className="absolute w-full h-[60%]  top-[25%] flex flex-col justify-center">
                  ...
                  <div className="absolute  z-20 w-[600px]  ml-[150px]">
                    <h1 className="text-[3rem] mb-0">{slide.categoryName.name} Movie</h1>
                ...
                <Slider {...settingsThumbs} >
                  {slidesMovies1.map((thumb) =>
                    <div className="thumbnail-container relative top-[40%] bg-pink-400 border-[#D96C2C] border-[2px] h-[120px] w-[50%] flex gap-5" key={thumb.id}>
                      <img className="mr-[50px] w-full h-[117px] object-cover" src={thumb.picture} alt={thumb.title} />
                      <button onClick={() => openModal(`http://localhost:5277/videos/${thumb.trailer}`)} className="play-button absolute">
              ...
              {slidesMovies1.map((slide) =>
                <div key={slide.id} className=" px-3">
                  <div className="cardmain bg-pink-200 w-full h-full relative">
                    <img className="card-Movies w-full h-[117px] object-cover" src={slide.picture} alt="" />
          ...
          <div className=" w-full grid grid-cols-3 gap-5 mt-7">
            {slidesMovies1.slice(0, 3).map((slide) =>
              <div key={slide.id} className=" relative">
                <img className="image-featured w-full h-[260px] object-cover" src={slide.picture} alt="" />
                <div className="">
                  <div className="cardmain absolute bg-white  w-[90%] h-[200px] left-5 top-[230px] px-[40px]">
                    ...
                    <div className="flex gap-4 mt-2">
                      <div className="flex gap-1 items-center">
                        ...
                        <p className="text-2">{slide.categoryName.name}</p>
                      </div>
                      <div className="flex gap-1 items-center">
