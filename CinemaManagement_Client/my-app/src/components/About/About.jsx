...
function About() {
    ...
    return (
        <div>
            ...
            <div className="elementor elementor-30" style={{ marginBottom: '106px' }}>
                <section
                                ...
                                <div className="elementor-element elementor-element-259763b elementor-widget elementor-widget-aovis_elementor_heading">
                                    <div className="elementor-widget-container">
                                        <div className="ova-heading ova-heading-template1">
                                            <div className="icon">
                                                <i class="fa-solid fa-video" style={{ color: '#d96c2c' }}></i>
                                            </div>
                                ...
                                <div className="elementor-widget-container">
                                    <div className="ova-heading ova-heading-template1">
                                        <div className="icon" style={{ textAlign: 'center' }}>
                                            <i className="fa-solid fa-video" style={{ color: '#d96c2c' }}></i>

                                        </div>
                                        <div class="top-heading1" style={{ textAlign:'center' }}>
                                            <h3 className="sub-title " style={{ textAlign: 'right', marginRight: '186px' }}>The Film Crew</h3>
                                            <h2 className="title" style={{ color: '#000000', fontWeight: 'bold', fontFamily: 'Space Grotesk',  }}>Professional Film Crew</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="elementor-widget-container">
                                    <div className="ova-heading ova-heading-template1">
                                        ...
                                        <div class="top-heading" >
                                            <h3 className="sub-title " style={{ color:'#737373' ,marginTop:'12px'}}>Our Feedbacks</h3>
