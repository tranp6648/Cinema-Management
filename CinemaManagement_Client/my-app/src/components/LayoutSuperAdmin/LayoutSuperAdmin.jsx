                ...
                <section className="sidebar h-auto">
                    ...
                    <ul className="sidebar-menu">
                        ...
                        <li className="active treeview">
                            <a href="" onClick={() => navigate('/SuperAdmin')}>
                                <i className="fa fa-dashboard" ></i> <span>Dashboard</span>
                            </a>

                        </li>
                        <li className="active treeview">
                        <a href="" onClick={() => navigate('/SuperAdmin/CAM')}>
                                <i className="fa fa-dashboard" ></i> <span>Category-Actor-Movie</span>
                            </a>

                        </li>
                        <li className="active treeview">
                        <a href="" onClick={() => navigate('/SuperAdmin/Cinema')}>
                                <i className="fa fa-dashboard" ></i> <span>Cinema</span>
                            </a>
